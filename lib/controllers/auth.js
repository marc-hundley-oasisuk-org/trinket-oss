var _             = require('underscore'),
    ...
    httpClient    = require('../util/http-client'),
...
function requestJson(options) {
  return httpClient.requestJson(options);
}
...
module.exports = {
  ...
  googleCallback : function(request, h) {
    ...
    return httpClient.postFormJson('https://oauth2.googleapis.com/token', {
      code: code,
      client_id: config.app.auth.google.clientID,
    ...
    .then(function(accessToken) {
      return httpClient.getJson('https://www.googleapis.com/oauth2/v2/userinfo', {
